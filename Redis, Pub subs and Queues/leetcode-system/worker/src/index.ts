...
async function main() {   
    ...
    while(1) {
        const response = await client.brPop("submissions", 0);      // brPop means blocked pop, 2nd argument is time: 0 specifies infinite time waiting, until there someone pushed anything in queue
